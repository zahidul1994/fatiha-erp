...
<table border="0" align="center" cellpadding="0" cellspacing="0" width="100%" style="width:100%;max-width:100%;">
    <tr><!-- Outer Table -->
                        ...
                        <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation" class="row" width="580" style="width:580px;max-width:580px;">
                            ...
                            <tr  >
                                <td class="center-text"  align="center" style="font-family:'Poppins',Arial,Helvetica,sans-serif;font-size:16px;line-height:26px;font-weight:300;font-style:normal;color:#FFFFFF;text-decoration:none;letter-spacing:0px;">
                                    Please Use The Information to Login
                                    <h4 class="mb-3" style="color:yellow">
                                           Email : <a title="{{$data['email']}}" href="mailto:{{$data['email']}}" style="color: rgb(24, 4, 24)">Your Email</a><br>
                                           Phone : <a title="{{$data['phone']}}" href="callto:{{$data['phone']}}" style="color: rgb(17, 2, 17)">Your Phone</a><br>
                                           Pass: <a href="{{$data['phone']}}" style="color: rgb(17, 2, 17)"> {{$data['phone']}}</a><br>
                                           web :  <a href="https://www.sohibd.com" style="color:black" target="_blank">Sohibd</a> <br>
                                           Login : <a href="https://www.sohibd.com/login/admin" style="color:black" target="_blank">Admin Login</a>  <br>
                                    ...
                                    <div >
                                        SohiBD is the Best Web Base software Company in Bangladesh. Thats Not True !, But Near Future We Can Do That . If Your Can Join Us.
                                    </div>
                                    ...
                                    <table border="0" cellspacing="0" cellpadding="0" role="presentation" align="center" class="center-float">
                                        <tr>
                                            <td align="center"    bgcolor="#d6df58" style="border-radius: 6px;">
                                                ...
                                                <a href="https://www.sohibd.com" target="_blank"    style="font-family:'Roboto Slab',Arial,Helvetica,sans-serif;font-size:16px;line-height:19px;font-weight:700;font-style:normal;color:#000000;text-decoration:none;letter-spacing:0px;padding: 20px 50px 20px 50px;display: inline-block;"><span>Visit </span></a>
        ...
        <h3 class="mb-1">
            ...
            <strong>
         Copyright© 2016-{{ date('Y') }}  by SohiBD.
            </strong>
        </h3>
