                        ...
                        <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation" class="row" width="580" style="width:580px;max-width:580px;">
                            ...
                            <tr  >
                                <td class="center-text"  align="center" style="font-family:'Poppins',Arial,Helvetica,sans-serif;font-size:16px;line-height:26px;font-weight:300;font-style:normal;color:#FFFFFF;text-decoration:none;letter-spacing:0px;">
                                    Please Use The Information to Veify Email
                                    <h3 class="mb-3" style="color:yellow">
                                          
                                          Verify Code : <strong> {!! $data['otp'] !!}</strong><br>
                                 
                                           Login : <a href="https://www.sohibd.com/cliet/emailverify" style="color:black" target="_blank">Veify Mail</a>  <br>
                                    ...
                                    <div >
                                        SohiBD is the Best Web Base software Company in Bangladesh. 
                                    </div>
                                    ...
                                    <table border="0" cellspacing="0" cellpadding="0" role="presentation" align="center" class="center-float">
                                        <tr>
                                            <td align="center"    bgcolor="#d6df58" style="border-radius: 6px;">
                                                ...
                                                <a href="https://www.sohid.com" target="_blank"    style="font-family:'Roboto Slab',Arial,Helvetica,sans-serif;font-size:16px;line-height:19px;font-weight:700;font-style:normal;color:#000000;text-decoration:none;letter-spacing:0px;padding: 20px 50px 20px 50px;display: inline-block;"><span>Visit </span></a>
