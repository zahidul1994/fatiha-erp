              ...
              <div class="table table-responsive">
                <table class="table table-bordered table-success align-items-center mb-0 table-striped">
                  ...
                  <tbody id="itemlist">
                   ...
                   <tr>
                   <td style="width:250px; vertical-align: top; padding-top: 17px;"><input class="form-control input-sm" type="hidden" id="pid" name="product_id[]" value="{{$item->product_id}}" data-format="0" >{{$item->product_name}}<input type="hidden" name="product_name[]" value="{{$item->product_name}}"><input type="hidden" name="product_name[]" value="{{$item->product_name}}"></td>
