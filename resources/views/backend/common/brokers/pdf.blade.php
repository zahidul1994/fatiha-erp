    ...
    <div class="invoice" style="text-align: center;">
        ...
        <div style="width:100%;">
            <div style="width:50%;float:left;">
                <strong style="font-weight:100;">Customer Name : {{ @$customer->customer_name }}</strong>
                <br>
                <strong style="font-weight:100;">Total Due: {{@$customer->total_balance }}</strong>
                <br>
                <strong style="font-weight:100;">Phone : {{ @$customer->customer_phone }}</strong>
                <br>
                <strong style="font-weight:100;">Email : {{ @$customer->customer_email }}</strong>
                <br>
                <strong style="font-weight:100;">Address : {{ @$customer->address }}</strong>
                <br>
            </div>
