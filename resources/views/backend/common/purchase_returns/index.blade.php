            ...
            <div class="card">
                ...
                <div class="card-header pb-4">
                    ...
                    <div class="col-md-4 mx-auto col-sm-1">
                        <label for="customer_id">Purchase Return * </label>
                        {!! Form::select('purchase_id',[], null, ['id' => 'purchase', 'class' => 'form-control select2',
                        'tabindex' => 4]) !!}
                    </div>
...
<script>
    ...
    $('#purchase').select2({
       placeholder: 'Type A Purcahse Invoice/Date/Amount',
       minimumInputLength: 1,
       ajax: {
         type: "POST",
         url: "{{ URL(Request::segment(1).'/find-purchase') }}",
          dataType: "JSON",
             delay: 250,
         ...
         cache: true
            ...
            $('#purchase').change(function(e) {
                window.location.href ="{{url(Request::segment(1)) }}"+'/purchase-return-create/'+$(this).val();
