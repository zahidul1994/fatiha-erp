  ...
  <div class="multisteps-form__content">
    <div class="row mt-3">
      <div class="col-md-12">
        <div class="row">
          ...
          <div class="col-md-4 col-sm-1">
            <label for="work_id">Workorder Invoice * </label>
        {!! Form::select('work_order_id',$workOrders,null, ['id' => 'work_order_id', 'class' => 'form-control select2', 'tabindex' => 2]) !!}
          ...
          <div class="col-md-9 col-sm-1 mt-1">
            ...
            {!! Form::textarea('description', null, ['id' => 'note', 'class' => 'form-control','rows'=>1,'placeholder'=>'Note ', 'tabindex' =>4]) !!}
          </div>
          <div class="col-md-3 col-sm-1 mt-1">
            <label for="note">Total Quantity</label>
            <input type="number" name="total_quantity" data-format="0[.]00" data-formula="(SUM(Q1:Q5000))" class="form-control" readonly data-cell="G1" data-format="0[.]00"  step="any" min="0" max="99999999999999">
          </div>
        </div>
      </div>
    ...
    <div class="row">
      <div class="col-md-9"></div><div class="col-md-3 mt-3"><button class="btn btn-success" type="submit" tabindex="5">Save</button>
         <button class="btn btn-info" name="requisition" type="submit" tabindex="6">Save & Requisition</button>
        </div>
    </div>
   </div>
