...
<body onload="window.print()">
    <div class="main-invoice">
        ...
        <h6 style="text-align:center;margin-top:5px">Invoice No :{{@$sale->invoice_no}}  </h6>
        ...
        <div class="barcode" style="margin: 10px 0; text-align: center;">
         ...
         {{-- <p style="margin-top: 10px; border-bottom: 1px dotted #000; padding-bottom: 5px; display: inline-block">
            <span class="text-align: center;">Terms & Conditions</span>
         </p> --}}
...
<script src="{{ asset('backend/assets/js/jquery-3.6.3.min.js') }}"></script>
    <script type="text/javascript">
        ...
        setTimeout(function() {
            document.location.href = "{{ url(Request::segment(1) . '/sales') }}";
