<div class="multisteps-form__content">
      ...
      <div class="col-md-12">
        <div class="row">
          ...
          <div class="col-md-4 col-sm-1 mt-1">
            ...
            {!! Form::select('from_shop_id',Helper::shopPluckValue(), null, ['id' => 'from_shop_id', 'class' => 'form-control select2', 'tabindex' =>2]) !!}
          </div>
          <div class="col-md-4 col-sm-1 mt-1">
            <label for="to_shop_id">To Shop *</label>
            {!! Form::select('to_shop_id',Helper::shopPluckValue(), null, ['id' => 'to_shop_id', 'class' => 'form-control select2', 'tabindex' => 3]) !!}
          </div>


          <div class="col-md-12 col-sm-1 mt-1">
            <label for="note">Note</label>
            {!! Form::textarea('note', null, ['id' => 'note', 'class' => 'form-control','rows'=>2, 'tabindex' =>4]) !!}
          </div>
        </div>
      </div>
    </div>
          ...
          <div class="form-group">
            <div class="input-group input-group-alternative mb-4">
              ...
              <input value="" type="text" class="form-control ui-autocomplete-input" id="add_item"
                ...
                style="font-size:1.5em;color:blueviolet" tabindex="5">
    ...
    <div class="row">
      <div class="col-md-9"></div><div class="col-md-3 mt-3"><button class="btn btn-success" type="submit" tabindex="7">Save</button> <button class="btn btn-info" name="transfer" type="submit" tabindex="8">Save & Transfer</button></div>
    </div>
   </div>
