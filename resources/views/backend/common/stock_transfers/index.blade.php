            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-header pb-4">
                        <div class="d-lg-flex">
                            <div>
                                <h5 class="mb-0">All Stock Transfer</h5>
                            ...
                            <div class="ms-auto my-auto mt-lg-0 mt-4">
                                <div class="ms-auto my-auto">
                                    <a href="{{ route(Request::segment(1) . '.stock-transfers.create') }}"
                                        class="btn bg-gradient-primary btn-sm mb-0">+&nbsp; Stock Transfer</a>
  ...
  <script>
            $(document).ready(function() {
                $('#datatable-basic').DataTable({
                    ...
                    ajax: "{{ route(Request::segment(1) . '.stock-transfers.index') }}",
                    columns: [{
                            data: 'DT_RowIndex',
                            orderable: false,
                            searchable: false
                        ...
                        {
                            data: 'fromshop.shop_name',
                            name: 'shopfromshop.shop_name'
                        },
                        {
                            data: 'toshop.shop_name',
                            name: 'tofromshop.shop_name'
                        },
                        {
                            data: 'total_stock',
                            name: 'total_stock'
