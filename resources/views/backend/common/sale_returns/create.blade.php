      ...
      <div class="card">
        ...
        <div class="card-body">
          <div class="row">
            ...
            {!! Form::open(['route' => Request::segment(1) . '.sale-returns.store', 'method' => 'POST', 'id' =>
            'formReset']) !!}

            <div class="row">
              <div class="col-12 col-sm-6">
                <h5 class="font-weight-bolder mb-0">Sale Return Form</h5>
              </div>
            ...
            <div class="multisteps-form__content">
                  ...
                  <div class="row">
                    <div class="col-md-6 col-sm-1">
                      ...
                      1,'autofocus']) !!}
                          ...
                          <input type="hidden" name="sale_id" value="{{encrypt(Request::segment(3))}}">
                    ...
                    <div class="col-md-6 col-sm-1 mt-1">
                      ...
                      {!! Form::select('customer_id',Helper::customerPluckValue(), null, ['id' => 'customer_id', 'class' =>
                      'form-control select2','disabled']) !!}
                    ...
                    <div class="col-md-6 col-sm-1 mt-1">
                      ...
                      'payment_method', 'class' => 'form-control select2', 'tabindex' => 3]) !!}
                    ...
                    <div class="col-md-12 col-sm-1 mt-1">
                      ...
                      {!! Form::textarea('description', null, ['id' => 'note', 'class' => 'form-control','rows'=>2,
                      'tabindex' =>4]) !!}
                    </div>
                  </div>
                </div>
                ...
                <div class="col-md-4 col-sm-1 mt-3 mt-sm-0">
                  <div class="card">
                      ...
                      <div class="d-flex mb-1">
                        ...
                        <div class="w-75 ps-3 align-self-center">
                          <p class="text-center pa-box">
                            ...
                            <strong data-format="0[.]0000" data-formula="(SUM(F1:F5000)-O1)"></strong>
                          </p>
                        </div>
                      </div>
                    </div>
                    <div class="card-body pt-0 pr-0">
                        ...
                        <div class="d-flex mb-1">
                          <div class="w-25 pe-2 align-self-center">R Discount</div>
                          <div class="w-75 align-self-center">
                            <div class="row">
                                <div class="col-md-7"><input type="number" readonly name="other_discount"
                                    id="other_discount"  class="form-control text-end py-1 px-1" data-cell="L1"
                                    data-format="0[.]00" step="any" ></div>
                        ...
                        <div class="d-flex mb-1">
                          <div class="w-25 pe-2 align-self-center">Total Discount</div>
                          <div class="w-75 align-self-center">
              ...
              <div class="card mt-3 bottom-table-card" style="border-radius: 0 !important; font-size:150px">
                <div class="col-md-12 mx-auto">
                  <table class="table align-items-center table-bordered mb-0 table-success table-striped">
                    <thead>
                      <tr style="font-weight:900;background:peru; color:black">
                        ...
                        <th class="px-1 text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Sale Qty
                        </th>
                        <th class="px-1 text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">AR Qty
                        </th>
                        <th class="px-1 text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">NR Qty
                        </th>
                    ...
                    <tbody id="itemlist">
                      ...
                      @php
                        $avaboleqty= @$saledetail->qty-$saledetail->already_return_qty
                      @endphp
                     @if ($avaboleqty>0)
                  <tr>
                     <td style="width:220px; vertical-align: top; padding-top: 17px;"><input
                      class="form-control input-sm" type="hidden" id="pid" name="product_id[]"
                      value="{{ @$saledetail->product_id}}" data-format="0">{{ @$saledetail->product_name}} <input
                      type="hidden" name="product_name[]" value="{{ @$saledetail->product_name}}"> <input
                      type="hidden" name="average_purchase_price[]" value="{{ @$saledetail->average_purchase_price}}"></td>

                  <td style="width:180px;"><input class="form-control input-sm text-end" placeholder="0.00"
                      tabindex="10" name="product_price[]" data-cell="P{{$loop->index+1}}"
                      value="{{ @$saledetail->sale_price}}" readonly><i class="text-black-50">&nbsp;</i></td>

                      <td style="width:110px;"><input class="form-control input-sm text-end" required
                        type="number" readonly step="any" min=1 max=999999999
                        value="{{ @$saledetail->qty}}" name="product_quantity[]"><i class="text-black-50">&nbsp;</i> </td>

                      <td style="width:120px;"><input class="form-control input-sm text-end" placeholder="0.00"
                      tabindex="10" name="already_return_qty[]"
                      value="{{ @$saledetail->already_return_qty}}" readonly  data-format=""><i class="text-black-50">&nbsp;</i></td>

                  <td style="width:150px;"><input class="form-control input-sm text-end"
                      type="number"  step="any" min=1 max="{{$avaboleqty}}"
                      data-format=""  onkeypress="getQty({{$loop->index+1}},this);"   onblur="getQty({{$loop->index+1}},this);"
                    name="product_return_quantity[]" data-cell="Q{{$loop->index+1}}"><i class="text-black-50">&nbsp;</i></td>

                  <td style="width:120px;"><input type="number" step="any" min=0 max=999999999
                      class="form-control input-sm text-end" readonly onblur="getVat({{$loop->index+1}},this);"
                      placeholder="0.00" name="product_vat[]" data-cell="T{{$loop->index+1}}" value="{{ @$saledetail->vat_percent}}"
                      data-format="0[.]0000"><i
                      class="text-black-50">&nbsp;</i> </td>

                  <td style="width:100px;"><input name="product_vat_amount[]"
                      type="number" step="any" min=0 max=999999999 class="form-control input-sm text-end"
                  ...
                  <td style="width:100px;"><input name="product_discount[]"
                      value="{{ @$saledetail->discount_percent}}" readonly type="number" step="any" min=0 max=999999999
                      class="form-control input-sm text-end" placeholder="0.00" data-cell="D{{$loop->index+1}}"
                      onblur="getVat({{$loop->index+1}})" data-format="0[.]00"><i class="text-black-50">&nbsp;</i>
                  </td>

                  <td style="width:160px;"><input type="number"  step="any"
                      min=1 max=999999999 class="form-control input-sm text-end" placeholder="0.00"
                      name="product_discount_amount[]" readonly data-cell="N{{$loop->index+1}}" data-format="0[.]00"
                      data-formula="(P{{$loop->index+1}}/100*D{{$loop->index+1}})*Q{{$loop->index+1}}"><i
                      class="text-black-50">&nbsp;</i></td>

                      <td style="width:160px;"><input type="number"  step="any"
                        min=1 max=999999999 class="form-control input-sm text-end" placeholder="0.00"
                        name="product_total_price[]" readonly data-cell="F{{$loop->index+1}}" data-format="0[.]00"
                    ...
                    <tfoot>
                        ...
                        <th> <strong data-format="0[.]00"
                            >{{@$sale->saledetails->sum('sale_price')}}</strong></th>
                        <th> <strong data-format="0[.]00"
                           >{{@$sale->saledetails->sum('qty')}}</strong></th>
                        <th> <strong data-format="0[.]00"
                          >{{@$sale->saledetails->sum('already_return_qty')}}</strong></th>
                        <th> <strong data-format="0[.]00"
                            data-formula="(SUM(Q1:Q5000))"></strong></th>
                        <th> <strong data-format="0[.]00"
                            data-formula="(SUM(T1:T5000))"></strong></th>
                        <th> <strong data-format="0[.]00"
                            data-formula="(SUM(V1:V5000))"></strong></th>
                        <th> <strong data-format="0[.]00"
                            data-formula="(SUM(D1:D5000))"></strong></th>
                        <th> <strong data-format="0[.]00"
                            data-formula="(SUM(N1:N5000))"></strong>
                        </th>
                        <th> <strong data-format="0[.]0000"
                            data-formula="(SUM(F1:F5000))"></strong></th>
              ...
              <div class="row">
                ...
                <div class="col-md-3 mt-3"><button class="btn btn-success" type="submit" tabindex="6">Save & Return</button>
...
function getQty() {
  ...
  $form.calx('getCell', 'L1').setFormula('(SUM(Q1:Q5000)*Z1)');
  $form.calx('getCell', 'G1','L1').calculate();
  $form.calx('update');
}
//onkeyup
function getVat() {
