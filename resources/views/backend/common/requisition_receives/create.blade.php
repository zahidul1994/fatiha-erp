                ...
                <div class="col-md-12">
                  <div class="row">
                    ...
                    <div class="col-md-3 col-sm-1 mt-1">
                      ...
                      {!! Form::select('status',['Receive'=>'Receive','Partial'=>'Partial'], null, ['id' => 'note', 'class' =>
                    ...
                    <tr>
                              ...
                              <div class="row p-3">                               
                                <div class="col-md-3">
                                  ...
                                  {!! Form::text('product_name[]', $product->product_name?:null, ['id' => 'product_name','class' =>
                                ...
                                <div class="col-md-3">
                                  ...
                                  <div class="input-group">
                                    ...
                                    {!! Form::text('weight_size[]', $product->weight_size?:null, ['id' => 'weight_size','class' =>
                                    ...
                                    {!! Form::select('unit[]', Helper::unitPluckValue(), @$product->unit?:null, ['id' => 'unit', 'class'
                                    =>
                                ...
                                <div class="col-md-3">
                                  ...
                                  <div class="input-group">
                                    {!! Form::number('hs_code[]',  @$product->hs_code?:null, ['id' => 'hsCode','class' => 'form-control','required',
                                    ]) !!}                      
                                ...
                                <div class="col-md-3">
                                  ...
                                  <div class="input-group">
                                    {!! Form::number('qty[]',  @$order->qty?:null, ['id' => 'qty','class' => 'form-control','required','step'=>'any','data-cell'=>"Q$loopKey",'data-format'=>"",'keydown'=>'calculateFx()',
                                    'onblur'=>"calculateFx()",
                                    ]) !!}                      
                                    @if ($errors->has('qty')) <span class="text-danger alert">{{ $errors->first('qty') }}</span>
                                    @endif
                                  </div>
                                </div>
                              ...
                              <div class="row">
                                ...
                                <div class="col-md-4">
                                  ...
                                  'form-control','required','data-cell'=>"GP$loopKey",'data-format'=>"0[.]00", 'keydown'=>'calculateFx()',
                                  'onblur'=>"calculateFx()",'placeholder'=>'Govt Price'
                                  ]) !!}
                                  @if ($errors->has('govt_price')) <span class="text-danger alert">{{ $errors->first('govt_price')
                                    }}</span>
                                  @endif
                                </div>
                                <div class="col-md-4">
                                  <label for="insurance_before" class="mt-4">Insurance(B) (%) *</label>
                                  {!! Form::text('insurance_before[]', @$product->insurance_before?:null, ['id' => 'insurance_before','class' =>
                                  'form-control','required','data-cell'=>"INSB$loopKey",'data-format'=>"0[.]00", 'onblur'=>"calculateFx()",'placeholder'=>'Insurance Before'
                                  ]) !!}
                                ...
                                <div class="col-md-4">
                                  ...
                                  {!! Form::text('insurance_before_value[]', @$product->insurance_before_value?:null, ['id' => 'insurance_before_value','class' =>
                                ...
                                <div class="col-md-4">
                                  ...
                                  {!! Form::text('clearing_before[]', @$product->clearing_before?:null, ['id' => 'clearing_before','class' =>
                                  'form-control','required','data-cell'=>"CLRB$loopKey",'data-format'=>"0[.]00", 'keydown'=>"calculateFx()",
                                ...
                                <div class="col-md-4">
                                  ...
                                  {!! Form::text('clearing_before_value[]', @$product->clearing_before_value?:null, ['id' => 'clearing_before_value','class' =>
                                ...
                                <div class="col-md-4">
                                  ...
                                  {!! Form::text('convert_rate[]', @$product->convert_rate?:null, ['id' => 'convert_rate','class' =>
                                  'form-control','required','data-cell'=>"CONVR$loopKey",'data-format'=>"0[.]00", 'keydown'=>"calculateFx()",
                                  'onblur'=>"calculateFx()"
                                  ]) !!}
                                ...
                                <div class="col-md-4">
                                  ...
                                  {!! Form::text('duty_assessment_value[]', @$product->duty_assessment_value?:null, ['id' => 'duty_assessment_value','class' =>
                                ...
                                <div class="col-md-4">
                                  ...
                                  'form-control','required','data-cell'=>"CD$loopKey",'data-format'=>"0[.]00", 'keydown'=>"calculateFx()",
                                ...
                                <div class="col-md-4">
                                  ...
                                  'form-control','required','data-cell'=>"RD$loopKey",'data-format'=>"0[.]00", 'keydown'=>"calculateFx()",
                                ...
                                <div class="col-md-4">
                                  ...
                                  'form-control','required','data-cell'=>"SD$loopKey",'data-format'=>"0[.]00", 'keydown'=>"calculateFx()",
                                ...
                                <div class="col-md-4">
                                  ...
                                  'form-control','required','data-cell'=>"VAT$loopKey",'data-format'=>"0[.]00", 'keydown'=>"calculateFx()",
                                ...
                                <div class="col-md-4">
                                  ...
                                  'form-control','required','data-cell'=>"AIT$loopKey",'data-format'=>"0[.]00", 'keydown'=>"calculateFx()",
                                ...
                                <div class="col-md-4">
                                  ...
                                  'form-control','required','data-cell'=>"AT$loopKey",'data-format'=>"0[.]00", 'keydown'=>"calculateFx()",
                                ...
                                <div class="col-md-4">
                                  ...
                                  'form-control','required','data-cell'=>"ATV$loopKey",'data-format'=>"0[.]00", 'keydown'=>"calculateFx()",
                                ...
                                <div class="col-md-4">
                                  ...
                                  {!! Form::text('insurance_after[]', @$product->insurance_after?:null, ['id' => 'insurance_after','class' =>
                                  'form-control','required','data-cell'=>"INSUAFTR$loopKey",'data-format'=>"0[.]00", 'keydown'=>"calculateFx()",
                                ...
                                <div class="col-md-4">
                                  ...
                                  {!! Form::text('insurance_after_value[]', @$product->insurance_after_value?:null, ['id' => 'insurance_after_value','class' =>
                                ...
                                <div class="col-md-4">
                                  ...
                                  'form-control','required','data-cell'=>"BNKCRG$loopKey",'data-format'=>"0[.]00", 'keydown'=>"calculateFx()",
                                ...
                                <div class="col-md-4">
                                  ...
                                  {!! Form::text('bank_charge_value[]', @$product->bank_charge_value?:null, ['id' => 'bank_charge_value','class' =>
                                ...
                                <div class="col-md-4">
                                  ...
                                  {!! Form::text('clearing_after[]', @$product->clearing_after?:null, ['id' => 'clearing_after','class' =>
                                  'form-control','required','data-cell'=>"CLRAFTR$loopKey",'data-format'=>"0[.]00", 'keydown'=>"calculateFx()",
                                ...
                                <div class="col-md-4">
                                  ...
                                  {!! Form::text('clearing_after_value[]', @$product->clearing_after_value?:null, ['id' => 'clearing_after_value','class' =>
                                ...
                                <div class="col-md-4">
                                  ...
                                  {!! Form::text('carrying_value[]', @$product->carrying_value?:null, ['id' => 'carrying_value','class' =>
                                ...
                                <div class="col-md-4">
                                  ...
                                  'form-control','required','data-cell'=>"OTR$loopKey",'data-format'=>"0[.]00", 'keydown'=>"calculateFx()",
                                ...
                                <div class="col-md-4">
                                  ...
                                  {!! Form::text('purchase_price[]', @$product->purchase_price?:null, ['id' => 'purchase_price','class' =>
             ...
             <table  class="table">
                  ...
                  <tr>
                    ...
                    <td>
                          ...
                          class="form-control" readonly data-cell="TQ1" data-format="0[.]00" step="any" min="0" value="{{$requisition->total_quantity}}"
                          max="99999999999999">
                    ...
                    <td>
                            ...
                            <input type="number" name="grand_total" data-format="0[.]00" data-formula="(SUM(PPRICE1:PPRICE5000))"  readonly
                            class="form-control" readonly data-cell="G1" data-format="0[.]00" step="any" min="0"
                            max="99999999999999">
                    </td>
                    ...
                    <td>
                      ...
                      'form-control','data-cell'=>"DE1",'data-format'=>"0[.]00", 'data-formula'=>"(SUM(G1-PD1))", 'keydown'=>"calculateFx()",'step' => 'any', 'onblur'=>"calculateFx()",'placeholder'=>'Paid Amount','min' => '0', 'readonly',
                  'max' => '9999999999999999',
                      ]) !!}
