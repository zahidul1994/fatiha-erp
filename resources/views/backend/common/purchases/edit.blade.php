          ...
          <div class="row">
            ...
            <div class="multisteps-form__content">
                ...
                <div class="col-md-8">
                  <div class="row">
                    <div class="col-md-6 col-sm-1">
                      ...
                      {!! Form::date('date', null, ['id' => 'date', 'class' => 'form-control', 'required', 'tabindex' =>
                      1,'autofocus']) !!}

                    </div>
                    <div class="col-md-6 col-sm-1">
                      <label for="reference">Reference</label>
                      {!! Form::text('reference', null, ['id' => 'reference', 'class' => 'form-control', 'tabindex' =>
                      2]) !!}
                    ...
                    <div class="col-md-4 col-sm-1 mt-1">
                      ...
                      {!! Form::select('payment_method',Helper::custompaymentMethodPluckValue(), null, ['id' =>
                    ...
                    <div class=" row d-none" id="MobileBankPayment">
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          {!! Form::tel('phone_number', @$paymentInfo->phone_number?:null, ['id' => 'phone_number',
                          'class' =>'form-control']) !!}
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          {!! Form::text('transaction_number',@$paymentInfo->transaction_number?:null, ['id' => 'paid',
                          'class' =>'form-control'
                          ]) !!}
                        </div>
                      </div>
                    ...
                    <div class=" row d-none" id="BankPayment">
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          {!! Form::text('bank_name',@$paymentInfo->bank_name?:null, ['id' => 'bank_name', 'class'
                          =>'form-control']) !!}
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          {!! Form::number('bank_account_number',@$paymentInfo->bank_account_number?:null, ['id' =>
                        ...
                        <div class="w-75 ps-3 align-self-center">
                          <p class="text-center pa-box">
                            ...
                            <strong id="totalPayment"
                              data-formula="(SUM(F1:F5000)-(D1))">{{$purchase->sub_total}}</strong>
                          </p>
                        </div>
                      </div>
                    </div>
                    <div class="card-body pt-0 pr-0">
                      <div class="d-flex mb-1">
                        ...
                        <div class="w-75 align-self-center">
                          <input type="number" name="total_vat" value="{{$purchase->total_vat}}" id="total_vat"
                            class="form-control text-end py-1 px-1" readonly data-format="0[.]00"
                            data-formula="SUM(V1:V500)" step="any" min="0" max="99999999999999" data-cell="C1">
                        </div>
                      </div>
                      ...
                      <div class="d-flex mb-1">
                        ...
                        <div class="w-75 align-self-center">
                          <div class="row">
                              <div class="col-md-7"><input type="number" value="{{$purchase->total_discount}}" name="total_discount" onkeypress="getQty()"  onblur="getQty()" class="form-control text-end py-1 px-1"  data-cell="D1" data-format="0[.]00"  step="any" min="0" max="99999999999999"></div>
                      ...
                      <div class="d-flex mb-1">
                        ...
                        <div class="w-75 align-self-center">
                          {!! Form::number('paid', null, ['id' => 'total_paid', 'class' => 'form-control text-end py-1
                          px-1','step'=>'any','min'=>0,'max'=>9999999999999,'readonly']) !!}
                        </div>
                      </div>
                      <div class="d-flex mb-1">
                        <div class="w-25 pe-2 align-self-center">Grand Total</div>
                        <div class="w-75 align-self-center">
                            <input type="hidden" value="{{$purchase->total_quantity}}" name="total_quantity" data-format="0[.]00" data-formula="(SUM(Q1:Q5000))" >
                          <input type="number" name="total_amount" value="{{$purchase->grand_total}}" id="grand_total"
                            class="form-control text-end py-1 px-1" readonly data-cell="G1" data-format="0[.]00"
                            data-formula="SUM(F1:F5000,C1)-D1" step="any" min="0" max="99999999999999">
                        </div>
                      </div>
                  ...
                  <table class="table table-bordered table-success align-items-center mb-0 table-striped">
                    ...
                    <tbody id="itemlist">
                      ...
                      <td style="width:250px; vertical-align: top; padding-top: 17px;"><input
                        ...
                        @$purchasedetail->product_name}}  <input
                          type="hidden" name="product_name[]" value="{{ @$purchasedetail->product_name}}"></td>
                          <td style="width:130px;"><input type="date" class="form-control input-sm text-end" name="product_expire_date[]"
                            value="{{@$purchasedetail->product_expire_date}}" style="margin-top:-20px"></td>
                      <td style="width:120px;"><input class="form-control input-sm text-end" placeholder="0.00"
                          tabindex="10" name="product_price[]" onblur="getQty({{$loop->index+1}},this);" data-cell="P{{$loop->index+1}}"
                          value="{{@$purchasedetail->purchase_price}}" data-format=""><i
                          class="text-black-50">&nbsp;</i></td>

                      <td style="width:120px;"><input class="form-control input-sm text-end pquentity" required
                          type="number" step="any" min=1 max=999999999 required id="id{{ @$purchasedetail->product_id}}"
                          data-format="" data-format="0[.]00" onblur="getQty({{$loop->index+1}},this);"
                          value="{{ @$purchasedetail->qty}}" readonly name="product_quantity[]"
                          data-cell="Q{{$loop->index+1}}"><i class="text-black-50">S- {{
                          @$purchasedetail->product->sale_price}}</i> </td>
                      ...
                      <td style="width:80px;"><input type="number" step="any" min=0 max=999999999
                          ...
                          value="{{ @$purchasedetail->vat_percent}}" data-format="0[.]0000"><i
                          class="text-black-50">&nbsp;</i> </td>

                      <td style="width:100px;"><input name="product_vat_amount[]"
                          value="{{ @$purchasedetail->vat_amount}}" type="number" step="any" min=0 max=999999999
                      ...
                      <td style="width:160px;"><input type="number" readonly value="{{@$purchasedetail->total_price}}" step="any"
                          ...
                          data-formula="(Q{{$loop->index+1}})*(P{{$loop->index+1}})"><i class="text-black-50">&nbsp;</i>
                      </td>
                    ...
                    <tfoot>
                      <th colspan="2"></th>
                      <th> <strong
                          data-formula="(SUM(P1:P5000))">{{@$purchase->purchasedetails->sum('purchase_price')}}</strong>
                      </th>
                      <th> <strong data-formula="(SUM(Q1:Q5000))">{{@$purchase->purchasedetails->sum('qty')}}</strong>
                      </th>
                      <th> <strong
                          data-formula="(SUM(T1:T5000))">{{@$purchase->purchasedetails->sum('vat_percent')}}</strong>
                      </th>
                      <th> <strong data-formula="(SUM(V1:V5000))">{{@$purchase->purchasedetails->sum('vat_amount')}}
                        </strong></th>
                      <th> <strong
                          data-formula="(SUM(F1:F5000))">{{@$purchase->purchasedetails->sum('total_price')}}</strong>
                      </th>
                      <th></th>
                    </tfoot>
                  </table>
              ...
              <div class="row">
                ...
                <div class="col-md-3 mt-3"><button class="btn btn-success" type="submit" tabindex="10">Update</button>
                 </div>
              </div>
            </div>
            {!! Form::close() !!}
         ...
         if (ui.item.id !== 0) {
            ...
            $counter = $("#itemlist tr").length;
                ...
                $itemlist.append( '<tr>\
                        ...
                        <td style="width:120px;"><input class="form-control input-sm text-end pquentity" required  type="number" step="any" min=1 max=999999999 required id="id'+row.id+'" data-format="" data-format="0[.]00"  onClick="getQty(' + i + ',this);" onblur="getQty(' + i + ',this);"   name="product_quantity[]"  data-cell="Q'+i+'"><i class="text-black-50">'+'S-' +row.saleprice+'</i></td> \
