    ...
    <div class="product_details">
        <table>
            ...
            <tfoot>
                ...
                <tr>
                    <td colspan="5" style="text-align: center">Payment Method: {{@$purchase->payment_method}}</td>
                    <td colspan="2" style="text-align: right">Grand Total</td>
                    <td> {{(@$purchase->grand_total) }}</td>
                   </tr>
                <tr>
                    <td colspan="5" style="text-align: center"> @if (@$purchase->payment_method=='Bkash' ||@$purchase->payment_method=='Nagad'|| @$purchase->payment_method=='Rocket' )
                ...
                <tr>
                    ...
                    <td> {{(@$purchase->sub_total-@$purchase->paid) }}</td>
                   </tr>
            </tfoot>
        </table>
    </div>
