      ...
      <div class="col-md-8">
        <div class="row">
          ...
          <div class="col-md-4 col-sm-1 mt-1">
            ...
            @if(isset(Helper::adminSetup()->default_supplier_id))
          {!! Form::select('supplier_id',Helper::supplierPluckValue(), Helper::adminSetup()->default_supplier_id?:null, ['id' => 'supplier', 'class' => 'form-control select2', 'tabindex' => 4]) !!}
          @else
          {!! Form::select('supplier_id',Helper::supplierPluckValue(), null, ['id' => 'supplier', 'class' => 'form-control select2', 'tabindex' => 4]) !!}
              ...
              <div class="w-75 ps-3 align-self-center">
                <p class="text-center pa-box">
                  <span class="d-block">Payable Amount</span>
                   <strong id="totalPayment" data-formula="(SUM(F1:F5000)-(D1))"></strong>
                </p>
              </div>
            </div>
          </div>
          <div class="card-body pt-0 pr-0">
            ...
            <div class="d-flex mb-1">
              ...
              <div class="w-75 align-self-center">
                <input type="number" name="total_vat"  id="total_vat" class="form-control text-end py-1 px-1" readonly   data-formula="SUM(V1:V500)" data-format="0[.]00" step="any" min="0" max="99999999999999" data-cell="C1">
              </div>
            </div>
            ...
            <div class="d-flex mb-1">
              ...
              <div class="w-75 align-self-center">
                <div class="row">
                    <div class="col-md-7"><input type="number" name="total_discount" onkeypress="getQty()"  onblur="getQty()" class="form-control text-end py-1 px-1"  data-cell="D1" data-format="0[.]00"  step="any" min="0" max="99999999999999"></div>
            ...
            <div class="d-flex mb-1">
              ...
              <div class="w-75 align-self-center">
                {!! Form::number('paid', null, ['id' => 'total_paid', 'class' => 'form-control text-end py-1 px-1','step'=>'any','min'=>0,'max'=>9999999999999, 'tabindex' => 9,'onkeypress'=>"getQty()"]) !!}
                </div>
            </div>
            <div class="d-flex mb-1">
              ...
              <div class="w-75 align-self-center">
                ...
                <input type="number" name="total_amount"  id="grand_total" class="form-control text-end py-1 px-1" readonly data-cell="G1" data-format="0[.]00" data-formula="SUM(F1:F5000,C1)-D1" step="any" min="0" max="99999999999999">
                </div>
            </div>
          ...
          <div class="form-group">
            <div class="input-group input-group-alternative mb-4">
              ...
              <input value="" type="text" class="form-control ui-autocomplete-input" id="add_item"
                ...
                style="font-size:1.5em;color:blueviolet" tabindex="8">
