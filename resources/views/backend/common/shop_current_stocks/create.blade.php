         ...
         if (ui.item.id !== 0) {
            ...
            $counter = $("#itemlist tr").length;
               ...
               $itemlist.append( '<tr>\
                        ...
                        <td style="width:80px;"><input class="form-control input-sm text-end pquentity" required  type="number" step="any" min=1 max=999999999 required id="id'+row.id+'" data-format="" data-format="0[.]00" onblur="getQty(' + i + ',this);"   name="product_quantity[]"  data-cell="Q'+i+'"><i class="text-black-50">'+'S-' +row.saleprice+'</i></td> \
