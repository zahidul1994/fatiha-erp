      ...
      <div class="card-body">
        ...
        <div class="row">
          ...
          <div class="col-md-4">
            ...
            {!! Form::text('govt_price', null, ['id' => 'govt_price','class' =>
            'form-control','required','data-cell'=>"GP1",'data-format'=>"0[.]00", 'keydown'=>'calculateFx()',
          ...
          <div class="col-md-4">
            ...
            'form-control','required','data-cell'=>"INSB1",'data-format'=>"0[.]00", 'onblur'=>"calculateFx()",'placeholder'=>'Insurance Before'
            ]) !!}
          ...
          <div class="col-md-4">
            ...
            'form-control','required','data-cell'=>"CLRBVAL1",'data-format'=>"0[.]00",'data-formula'=>"SUM(((U1/100)*(CLRB1)))",
            'readonly'
            ]) !!}
          ...
          <div class="col-md-4">
            ...
            'form-control','required','data-cell'=>"DUTYAVAL1",'data-format'=>"0[.]00",'data-formula'=>"SUM((GP1+INSBVAL1+CLRBVAL1)*CONVR1)",
            'readonly'
            ]) !!}
          ...
          <div class="col-md-4">
            ...
            'form-control','required','data-cell'=>"INSUAFTRVAL1",'data-format'=>"0[.]00",'data-formula'=>"SUM((((U1+INSBVAL1+CLRBVAL1)*CONVR1)/100)*(INSUAFTR1))",
            'readonly'
            ]) !!}
          ...
          <div class="col-md-4">
            ...
            'form-control','required','data-cell'=>"BNKCRGVAL1",'data-format'=>"0[.]00",'data-formula'=>"SUM((((U1+INSBVAL1+CLRBVAL1)*CONVR1)/100)*(BNKCRG1))",
            'readonly'
            ]) !!}
          ...
          <div class="col-md-4">
            ...
            'form-control','required','data-cell'=>"CLRAFTRVAL1",'data-format'=>"0[.]00",'data-formula'=>"SUM((((U1+INSBVAL1+CLRBVAL1)*CONVR1)/100)*(CLRAFTR1))",
            'readonly'
            ]) !!}
          ...
          <div class="col-md-4">
            ...
            'form-control','required','data-cell'=>"CARRINGVAL1",'data-format'=>"0[.]00",'data-formula'=>"SUM((((U1+INSBVAL1+CLRBVAL1)*CONVR1)/100)*(CRRING1))",
            'readonly'
            ]) !!}
          ...
          <div class="col-md-4">
            ...
            'form-control','required','data-cell'=>"LCVAL1",'data-format'=>"0[.]00",'data-formula'=>"SUM(U1*CONVR1)",
            'readonly'
            ]) !!}
          ...
          <div class="col-md-4">
            ...
            'form-control','readonly','data-cell'=>"PPRICE1",'data-format'=>"0[.]00",'data-formula'=>"SUM(CDVAL1,RDVAL1,SDVAl1,VATVAL1,AITVAL1,ATVAL1,ATVVAL1,INSUAFTRVAL1,BNKCRGVAL1,CLRAFTRVAL1,CARRINGVAL1,LCVAL1,OTR1)"
            ]) !!}
