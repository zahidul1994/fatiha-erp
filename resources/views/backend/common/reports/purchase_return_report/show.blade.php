    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="border border-info">
                        ...
                        <h3 class="text-center bg-info">Purchase Return Report</h3>
                        {!! Form::open(['route' => Request::segment(1) . '.purchaseReturnReportShow', 'method' => 'POST','class'=>'form']) !!}
                        <div class="row mx-auto">
                           ...
                           <div class="form-group col-md-2">
                            ...
                            {!! Form::select('supplier_id',Helper::supplierPluckValue(), $supplier_id?:null, ['id' => 'supplier', 'class' => 'form-control select2', 'placeholder'=>'Select Supplier','tabindex' => 2]) !!}
                            ...
                            <div class="form-group col-md-2">
                                ...
                                <a href="{{ url(Request::segment(1) . '/purchase-report') }}"
                        ...
                        <table id="datatable" class="table table-flush">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><a href="{{route(request()->segment(1) . '.purchases.show', (encrypt($purchase->id)))}}" class="btn btn-success btn-sm waves-effect" style="width:50px; padding: 8px"><i class="fa fa-eye"></i></a><a href="{{route(request()->segment(1) . '.purchases.edit', (encrypt($purchase->id)))}}" class="btn btn-info btn-sm waves-effect" style="width:50px; padding: 8px;  margin-left:2px"><i class="fa fa-edit"></i></a></td>
