...
@section('title', 'Damage Product Report')
@push('css')
        ...
        <div class="col-md-12">
            ...
            <div class="card">
                <div class="border border-info">
                    ...
                    <h3 class="text-center bg-info">Damage Product Report</h3>
                    {!! Form::open(['route' => Request::segment(1) . '.damageProductReportShow', 'method' =>
                    'POST','class'=>'form']) !!}
                    <div class="row mx-auto">
                        ...
                        <div class="form-group col-md-2">
                            ...
                            <button type="submit" class="form-control btn btn-primary"> <i class='fas fa-search'></i>
                                Search</button>
                            <a href="{{ url(Request::segment(1) . '/damage-product-report') }}"
                ...
                <div class="container mt-1">
                    <div class="table-responsive">
                        ...
                        <table id="datatable" class="table table-flush">
                            ...
                            <tbody>
                                @foreach ($damageProducts as $item)
                                <tr class="">
                                    <td> {{ $loop->index + 1 }}</td>
                            ...
                            <tfoot>
                                <tr>
                                    ...
                                    <td><b>Total</b></td>
                                    <td><b>{{$damageProducts->sum('purchase_price')}}</b></td>
                                    <td><b>{{$damageProducts->sum('qty')}}</b></td>
                                    <td><b>{{$damageProducts->sum('vat_percent')}}</b></td>
                                    <td><b>{{$damageProducts->sum('vat_amount')}}</b></td>
                                    <td><b>{{$damageProducts->sum('total_price')}}</b></td>
                                </tr>
                            </tfoot>
                        </table>
                        @else
