    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="border border-info">
                        ...
                        <h3 class="text-center bg-info">Expense Report</h3>
                        {!! Form::open(['route' => Request::segment(1) . '.expenseReportShow', 'method' => 'POST','class'=>'form']) !!}
                        <div class="row mx-auto">
                           ...
                           <div class="form-group col-md-2">
                            <label for="expense_head_id" class="form-control-label"> Select Type </label>
                            {!! Form::select('expense_head_id',Helper::expenseHeadPluckValue(), $expense_head_id?:null, ['id' => 'expense_head_id', 'class' =>
                            'form-control select2','placeholder'=>'Select One','tabindex' => 2]) !!}
                        </div>
                            <!-- form start -->
                              <div class="form-group col-md-2">
                            ...
                            <div class="form-group col-md-2">
                                ...
                                <a href="{{ url(Request::segment(1) . '/expense-report') }}"
                        ...
                        <table id="datatable" class="table table-flush">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><a href="{{route(request()->segment(1) . '.expenses.show', (encrypt($expense->id)))}}" class="btn btn-success btn-sm waves-effect" style="width:50px; padding: 8px"><i class="fa fa-eye"></i></a></td>
