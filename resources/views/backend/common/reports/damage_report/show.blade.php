    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="border border-info">
                        ...
                        <h3 class="text-center bg-info">Damage Report</h3>
                        {!! Form::open(['route' => Request::segment(1) . '.damageReportShow', 'method' => 'POST','class'=>'form']) !!}
                        <div class="row mx-auto">
                            ...
                            <div class="form-group col-md-2">
                                ...
                                <a href="{{ url(Request::segment(1) . '/damage-report') }}"
                        ...
                        <table id="datatable" class="table table-flush">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><a href="{{route(request()->segment(1) . '.damage-products.show', (encrypt($damage->id)))}}" class="btn btn-success btn-sm waves-effect" style="width:50px; padding: 8px"><i class="fa fa-eye"></i></a></td>
