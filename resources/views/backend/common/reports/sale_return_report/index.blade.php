    ...
    <div class="row">
        <div class="col-md-12  mb-10">
            ...
            <div class="border-top border-info">
                        ...
                        <h3 class="text-center bg-info">Sale Return Report</h3>
                        {!! Form::open(['route' => Request::segment(1) . '.saleReturnReportShow', 'method' => 'POST','class'=>'form']) !!}
                        ...
                        <div class="row mx-auto">
                            ...
                            <div class="form-group col-md-2">
                                ...
                                {!! Form::select('customer_id',Helper::customerPluckValue(), null, ['id' => 'customer_id', 'class' => 'form-control select2', 'placeholder'=>'Select Customer','tabindex' => 2]) !!}
