    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="border border-info">
                        ...
                        <h3 class="text-center bg-info">Loss Profit Report</h3>
                        {!! Form::open(['route' => Request::segment(1) . '.lossProfitReportShow', 'method' => 'POST','class'=>'form']) !!}
                        <div class="row mx-auto">
                           ...
                           <div class="form-group col-md-2">
                            ...
                            <div class="form-group col-md-2">
                                ...
                                <a href="{{ url(Request::segment(1) . '/loss-profit-report') }}"
                        ...
                        <table id="datatable" class="table table-flush">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{@$sale->total_loss_profit_amount}}</td>
                            ...
                            <tfoot>
                           <tr>
                            <td colspan="4"><b> Print Date-Time: {{now()}}</b></td>
                            <td ><b>Total</b></td>
                            <td><b>{{$sales->sum('grand_total')}}</b></td>
                            <td><b>{{$sales->sum('total_loss_profit_amount')}}</b></td>
                           </tr>
                            </tfoot>
                        </table>
                        @else
