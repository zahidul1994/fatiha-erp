                        ...
                        <div class="card move-on-hover mb-4">
                            <div class="card-body p-3">
                                <div class="row">
                                    <div class="col-8">
                                        <div class="numbers">
                                            <p class="text-sm mb-0 text-uppercase font-weight-bold"> Shop & Stock
                                            </p>
                                            <h5 class="font-weight-bolder">
                                                <span class="small"> </span><span id="counter6" countTo="{{count($shops)}} "></span>
                                               & ({{$totalStock->sum('stock_qty')}})
                                            </h5>
                                            <p class="mb-0">
                                                <a class="text-success text-sm font-weight-bolder" href="{{ route(Request::segment(1) . '.shops.index') }}">
                                                    <span >Go</span>
                                                    to  List   </a>
                                        </div>
                                    </div>
                        ...
                        <div class="card move-on-hover mb-4">
                            <div class="card-body p-3">
                                <div class="row">
                                    <div class="col-8">
                                        <div class="numbers">
                                            <p class="text-sm mb-0 text-uppercase font-weight-bold">Wallet Debit</p>
                                            <h5 class="font-weight-bolder">
                                                <span class="small"> </span><span id="counter17" countTo="{{($totalWallet->sum('debit'))}}"></span>

                                            </h5>
                                            <p class="mb-0">
                                                <a class="text-success text-sm font-weight-bolder" href="{{ route(Request::segment(1) . '.wallets.index') }}">
                                                    <span >Go</span>
                                                    to List   </a>
                                            </p>
                                        </div>
                        ...
                        <div class="card move-on-hover mb-4">
                            <div class="card-body p-3">
                                <div class="row">
                                    <div class="col-8">
                                        <div class="numbers">
                                            <p class="text-sm mb-0 text-uppercase font-weight-bold">Total Credit
                                            </p>
                                            <h5 class="font-weight-bolder">
                                                <span class="small"> </span><span id="counter18" countTo="{{($totalWallet->where('status',1)->sum('credit'))}}"></span>
                        ...
                        <div class="card move-on-hover mb-4">
                            <div class="card-body p-3">
                                <div class="row">
                                    <div class="col-8">
                                        <div class="numbers">
                                            <p class="text-sm mb-0 text-uppercase font-weight-bold">All Wallet</p>
                                            <h5 class="font-weight-bolder">
                                                <span class="small"> </span><span id="counter19" countTo="{{($totalWallet->where('status',1)->sum('credit'))-($totalWallet->sum('debit'))}}"></span>
                        ...
                        <div class="card move-on-hover mb-4">
                            <div class="card-body p-3">
                                <div class="row">
                                    <div class="col-8">
                                        <div class="numbers">
                                            <p class="text-sm mb-0 text-uppercase font-weight-bold">Pending Wallet</p>
                                            <h5 class="font-weight-bolder">
                                                <span class="small"> </span><span id="counter20" countTo="{{($totalWallet->where('status',0)->sum('credit'))}}"></span>
                                ...
                                <div class="row">
                                    <div class="col-8">
                                        <div class="numbers">
                                            ...
                                            <h5 class="font-weight-bolder">
                                                <span class="small"> </span><span id="counter13" countTo="{{count($users)}}"></span>
                        ...
                        <div class="card move-on-hover mb-4">
                            <div class="card-body p-3">
                                <div class="row">
                                    <div class="col-8">
                                        <div class="numbers">
                                            <p class="text-sm mb-0 text-uppercase font-weight-bold">Total Supplier
                                            </p>
                                            <h5 class="font-weight-bolder">
                                                <span class="small"> </span><span id="counter14" countTo="{{count($totalSupplier)}}"></span>

                                            </h5>
                                            <p class="mb-0">
                                                <a class="text-success text-sm font-weight-bolder" href="{{ route(Request::segment(1) . '.suppliers.index') }}">
                                                    <span >Go</span>
                                                    to List   </a>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-8">
                                        <div class="numbers">
                                            ...
                                            <h5 class="font-weight-bolder">
                                                <span class="small"> </span><span id="counter15" countTo="{{count($totalCustomer)}}"></span>

                                            </h5>
                                            <p class="mb-0">
                                                <a class="text-success text-sm font-weight-bolder" href="{{ route(Request::segment(1) . '.customers.index') }}">
                                                    <span >Go</span>
                                                    to List   </a>
                                            </p>
                                        </div>
                        ...
                        <div class="card move-on-hover mb-4">
                            <div class="card-body p-3">
                                ...
                                <div class="row">
                                    <div class="col-8">
                                        <div class="numbers">
                                            <p class="text-sm mb-0 text-uppercase font-weight-bold">Adjustment </p>
                                            <h5 class="font-weight-bolder">
                                                 <span class="small"> </span><span id="counter16" countTo="{{$stockAdjust->sum('total_current_stock')}}"></span>

                                            </h5>
                                            <p class="mb-0">
                                                <a class="text-success text-sm font-weight-bolder" href="{{ route(Request::segment(1) . '.stock-adjustments.index') }}">
                                                    <span >Go</span>
                                                    to List   </a>
                                            </p>
                                        </div>
