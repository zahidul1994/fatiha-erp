                ...
                <ul class="nav flex-column bg-white border-radius-lg p-3">
                    ...
                    <li class="nav-item pt-2">
                        <a class="nav-link text-body d-flex align-items-center" data-scroll="" href="#rating">
                            <i class="fa fa-star-o me-2 text-dark opacity-6"></i>
                    ...
                    <li class="nav-item pt-2">
                        <a class="nav-link text-body d-flex align-items-center" data-scroll="" href="#delete">
                            <i class="fa fa-bomb me-2 text-dark opacity-6"></i>
                            <span class="text-sm">Delete Account</span>
                        </a>
                    </li>
                    <li class="nav-item pt-2">
                        <a class="nav-link text-body d-flex align-items-center" href="{{ route(Request::segment(1) . '.payments') }}">
                            <i class="fa fa-google-wallet me-2 text-dark opacity-6"></i>
                            <span class="text-sm">Wallet</span>
                        </a>
                    </li>
                    <li class="nav-item pt-2">
                        <a class="nav-link text-body d-flex align-items-center" href="{{ route(Request::segment(1) . '.payments') }}">
                            <i class="fa fa-credit-card me-2 text-dark opacity-6"></i>
                ...
                <div class="row justify-content-center align-items-center">
                    ...
                    <div class="col-sm-auto ms-sm-auto mt-sm-0 mt-3 d-flex">
                        <label class="form-check-label mb-0">
                            <small id="profileVisibility">Refer And Win {{Helper::setting()->currency_name}} {{Helper::setting()->refer_amount}} {{Helper::setting()->currency_symbole}} </small>
                        </label>
                        <div class="form-check form-switch ms-2">
                            <a href="{{url('register')}}" target="_blank" class="btn btn-sm btn-success">Refer Now</a>
