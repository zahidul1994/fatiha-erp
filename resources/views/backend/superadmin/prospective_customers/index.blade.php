...
@section('title', 'Prospective Customer')
@push('css')
        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-header pb-4">
                    <div class="d-lg-flex">
                        <div>
                            <h5 class="mb-0">All Prospective Customer</h5>
                        ...
                        <div class="ms-auto my-auto mt-lg-0 mt-4">
                            <div class="ms-auto my-auto">
                                ...
                                <a href="{{ route(Request::segment(1) . '.prospective-customers.create') }}"
                                    class="btn bg-gradient-primary btn-sm mb-0">+&nbsp; New Prospective</a>
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <button type="button" class="btn btn-success" id="Sendsmssubmit">Send</button>
                                    </div>
                                    <!--bp area end-->
                                </div>
                                <!--bp area end-->
...
<script>
    $(document).ready(function() {
            ...
            $('#datatable-basic').DataTable({
                ...
                ajax: "{{ route(Request::segment(1) . '.prospective-customers.index') }}",
                columns: [{
                        data: 'DT_RowIndex',
                        orderable: false,
                        searchable: false
