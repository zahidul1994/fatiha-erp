...
<body class="g-sidenav-show   bg-gray-100">
    ...
    <div class="alert alert-warning alert-dismissible text-white mx-auto" role="alert" style="width: 80%">
        Your Are login As guest Admin  &nbsp;<a href="{{url('admin/login-superadmin',Session::get('superAdminId'))}}" class="alert-link text-white"> &nbsp; &nbsp; Back To Admin</a> Only Back offfice User can see This Allert 
