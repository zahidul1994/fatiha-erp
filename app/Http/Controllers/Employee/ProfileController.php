    ...
    public function index(Request $request)
    {
        try {
           ...
           $profileInfo= User::with('profile')->find(Auth::id());
            ...
            return view('backend.employee.setting.index',compact('profileInfo'));
            ...
            'country' => 'required',
               ...
               $user->email = $request->email;
                ...
                if ($request->hasFile('image')) {
                    ...
                    $name = $rand . "." . $ex;
                    $request->image->move(storage_path('/app/public/files/shares/uploads/' .  Auth::user()->admin_id . '/'), $name, 60);
                    ...
                    $user->image =url('storage/files/shares/uploads/'. Auth::user()->admin_id).'/'. $name;
                }
