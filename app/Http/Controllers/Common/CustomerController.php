    ...
    public function store(Request $request)
    {
        ...
        [
           ...
           try {
            ...
            $customer->total_due = $request->due?:0;
            $customer->total_paid = $request->paid?:0;
            $customer->total_balance =  $customer->total_due-$customer->total_paid;
          ...
          $customer->created_user_id = $this->User->id;
           ...
           if(!is_null($paid) || !is_null($due)){
            ...
            $customerdue->payment_method = 'Cash';
            $customerdue->paid = $paid?:0;
            $customerdue->due = $due?:0;
